...
(
  ...
  OppositionId SMALLINT(4) NOT NULL,
  TeamScore SMALLINT(3) NOT NULL,
  OppositionScore SMALLINT(3) NOT NULL,
  Win BIT(1) NOT NULL,
  OppositionPartnershipScore1 SMALLINT(4) NOT NULL,
  OppositionPartnershipScore2 SMALLINT(4) NOT NULL,
  OppositionPartnershipScore3 SMALLINT(4) NOT NULL,
  OppositionPartnershipScore4 SMALLINT(4) NOT NULL,
  TeamPartnershipScore1 SMALLINT(4) NOT NULL,
  TeamPartnershipScore2 SMALLINT(4) NOT NULL,
  TeamPartnershipScore3 SMALLINT(4) NOT NULL,
  TeamPartnershipScore4 SMALLINT(4) NOT NULL,
  PRIMARY KEY (GameId),
